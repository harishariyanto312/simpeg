...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated  = $request->validate([
            ...
            'emergency_contact_name.*' => ['required_with:emergency_contact_relationship.*,emergency_contact_phone.*', 'max:100', 'regex:/^[a-zA-Z\s]+$/'],
            'emergency_contact_relationship.*' => ['required_with:emergency_contact_name.*,emergency_contact_phone.*', 'max:30'],
            'emergency_contact_phone.*' => ['required_with:emergency_contact_name.*,emergency_contact_relationship.*', 'max:45', 'regex:/^[0-9]+$/'],

            'education_type.*' => ['required_with:education_date_aquired.*,education_grade.*,education_school_name.*,education_city.*'],
            'education_date_aquired.*' => ['required_with:education_type.*,education_grade.*,education_school_name.*,education_city.*'],
            'education_grade.*' => ['required_with:education_type.*,education_date_aquired.*,education_school_name.*,education_city.*'],
            'education_school_name.*' => ['required_with:education_type.*,education_date_aquired.*,education_grade.*,education_city.*'],
            'education_city.*' => ['required_with:education_type.*,education_date_aquired.*,education_grade.*,education_school_name.*'],
            'education_certificate_number.*' => ['nullable'],

            'family_name.*' => ['required_with:family_relationship.*,family_sex.*,family_birth_date.*,family_same_company.*'],
            'family_relationship.*' => ['required_with:family_name.*,family_sex.*,family_birth_date.*,family_same_company.*'],
            'family_sex.*' => ['required_with:family_name.*,family_relationship.*,family_birth_date.*,family_same_company.*'],
            'family_birth_date.*' => ['required_with:family_name.*,family_relationship.*,family_sex.*,family_same_company.*'],
            'family_status.*' => ['nullable'],
            'family_same_company.*' => ['required_with:family_name.*,family_relationship.*,family_sex.*,family_birth_date.*'],

            'exp_company_name.*' => ['required_with:exp_start_date.*,exp_end_date.*,exp_end_job_title.*,exp_end_pay_rate.*,exp_company_city.*'],
            'exp_start_date.*' => ['required_with:exp_company_name.*,exp_end_date.*,exp_end_job_title.*,exp_end_pay_rate.*,exp_company_city.*'],
            'exp_end_date.*' => ['required_with:exp_company_name.*,exp_start_date.*,exp_end_job_title.*,exp_end_pay_rate.*,exp_company_city.*'],
            'exp_end_job_title.*' => ['required_with:exp_company_name.*,exp_start_date.*,exp_end_date.*,exp_end_pay_rate.*,exp_company_city.*'],
            'exp_end_pay_rate.*' => ['required_with:exp_company_name.*,exp_start_date.*,exp_end_date.*,exp_end_job_title.*,exp_company_city.*'],
            'exp_job_desc.*' => ['nullable'],
            'exp_job_remarks.*' => ['nullable'],
            'exp_company_city.*' => ['required_with:exp_company_name.*,exp_start_date.*,exp_end_date.*,exp_end_job_title.*,exp_end_pay_rate.*'],
