...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated  = $request->validate([
            ...
            'nssf_occupation_number' => ['nullable', 'max:30'],
            'nssf_occupation_join_year' => ['nullable', 'regex:/^[0-9]{4}$/'],
            'nssf_occupation_join_month' => ['nullable'],

            'nssf_health' => ['required', 'in:Y,N'],
            'nssf_health_number' => ['nullable', 'max:30'],
            'nssf_health_join_year' => ['nullable', 'regex:/^[0-9]{4}$/'],
