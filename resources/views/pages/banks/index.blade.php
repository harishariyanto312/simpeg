<x-admin-layout :breadcrumb="$breadcrumb">
    <x-slot name="page_title">@lang('system.banks')</x-slot>
    ...
    <div class="mb-3 d-flex justify-content-between">
        <div></div>
        <div>
            <a href="{{ route('banks.create') }}" class="btn btn-primary">@lang('system.banks_create')</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <table
                id="mainTable"
                data-toggle="table"
                data-url="{{ route('banks.index.json') }}"
                data-side-pagination="server"
                data-pagination="true"
                data-page-size="10">
                <thead>
                    <tr>
                        <th data-field="bank" data-sortable="true">@lang('system.bank_bank')</th>
    ...
    <x-modal-delete :item="__('system.bank')"></x-modal-delete>
